...
js_bar = dbc.NavbarSimple(
    children=[
        dbc.NavItem(dbc.NavLink("Overview", id="overview_link", href="#")),
        dbc.NavItem(dbc.NavLink("Payment over time", id="payment_scatter_link", href="#")),
        dbc.NavItem(dbc.NavLink("Amortization schedule", id="schedule_link", href="#")),
        dbc.NavItem(dbc.NavLink("WIBOR effect", id="WIBOR_link", href="#")),
        ],
...
app.layout = html.Div(
    [default, custom_default, logo, search_navbar, dashboard, js_bar]
)
